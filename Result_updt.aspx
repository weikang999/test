<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Result_updt.aspx.cs" Inherits="Result_updt" %>
...
<div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="Result_updt.aspx?f=f" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" style="width:150px;" id="type" name="type" value="<%= Info.html(mmm["type"]) %>"/></div>
    </div>
</div><div class="form-group">
    <div class="row">
