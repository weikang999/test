<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subject_list_publisher.aspx.cs" Inherits="Subject_list_publisher" %>
                    ...
                    %>
                        <tr id="<%= map["id"] %>" pid="">
                            ...
                            <td align="center">
                                ...
                                <a href="QuestionInfo_add.aspx?id=<%= map["id"] %>">题库添加</a>
                                <a href="QuestionInfo_list.aspx?subjectid=<%= map["id"] %>">题库查询</a>
