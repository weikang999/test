<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Result_add.aspx.cs" Inherits="Result_add" %>
...
<div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="Result_add.aspx?f=f" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" style="width:150px;" id="type" name="type" value=""/></div>
    </div>
</div><div class="form-group">
    <div class="row">
