...
<div class="panel panel-default">
    ...
    类型
    <select class="form-control class_type1" data-value="<%= Request["type"] %>" id="type" name="type"><option value="">请选择</option><option value="单选题">单选题</option><option value="多选题">多选题</option></select><script>
