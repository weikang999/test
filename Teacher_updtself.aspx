<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Teacher_updtself.aspx.cs" Inherits="Teacher_updtself" %>
...
<div class="panel panel-default">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <select class="form-control class_sex7" data-value="<%= Info.html(mmm["sex"]) %>" id="sex" name="sex" style="width:250px"><option value="man">man</option><option value="woman">woman</option></select><script>
$(".class_sex7").val($(".class_sex7").attr("data-value"))</script></div>
    </div>
</div><div class="form-group">
    <div class="row">
