...
<div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="QuestionInfo_add.aspx?f=f" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" style="width:250px;" data-rule-required="true" data-msg-required="请填写试题题目" id="question" name="question" value=""/></div>
    </div>
</div><div class="form-group">
    <div class="row">
        <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">类型</label>
        <div class="col-sm-8">
            <select class="form-control class_type3" data-value="" id="type" name="type" style="width:250px"><option value="单选题">单选题</option><option value="多选题">多选题</option></select></div>
    </div>
</div><div class="form-group">
    <div class="row">
