...
<div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="Teacher_add.aspx?f=f" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    <div class="form-group">
    <div class="row">
        <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">用户名<span style="color: red;">*</span></label>
        <div class="col-sm-8">
            <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写用户名" remote="action.ashx?a=checkno&checktype=insert&table=teacher&col=username" data-msg-remote="内容重复了" id="username" name="username" value=""/></div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <select class="form-control class_sex6" data-value="" id="sex" name="sex" style="width:250px"><option value="man">man</option><option value="woman">woman</option></select></div>
    </div>
</div><div class="form-group">
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写手机号" phone="true" data-msg-phone="请输入正确手机号码" id="phonenumber" name="phonenumber" value=""/></div>
    </div>
</div><div class="form-group">
    <div class="row">
        <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">身份证号<span style="color: red;">*</span></label>
        <div class="col-sm-8">
            <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写身份证号" idcard="true" data-msg-email="请输入有效身份证号码" id="idnumbe" name="idnumbe" value=""/></div>
    </div>
</div><div class="form-group">
    <div class="row">
